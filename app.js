(async()=>{
  const VERSION='premiumtest20';
  const critical=['app-api-session.js','cloud-sync.js','app-core.js','app-local-scope.js','app-budget.js','app-contract.js','app-users.js','app-users-security.js','app-polish.js','app-auth-credential.js','app-isolation.js','app-rate-limit.js','app-2fa-login.js','app-settings.js','app-logout-fix.js','app-cookies.js','app-security-panel.js','app-online-mode.js','app-access-enforcement.js'];
